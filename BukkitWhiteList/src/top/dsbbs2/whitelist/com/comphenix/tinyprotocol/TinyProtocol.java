package top.dsbbs2.whitelist.com.comphenix.tinyprotocol;
...
import top.dsbbs2.whitelist.com.comphenix.tinyprotocol.Reflection.FieldAccessor;
import top.dsbbs2.whitelist.com.comphenix.tinyprotocol.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
	...
	private void unregisterChannelHandler() {
		...
		for (Channel serverChannel : serverChannels) {
			...
			}catch(Throwable e) {try{pipeline.remove(serverChannelHandler);}catch(Throwable e2) {}}
		}
	}
	...
	protected String getHandlerName() {
		return "tiny-" + plugin.getName() + "-" + ID.incrementAndGet() + "-" + UUID.randomUUID();
	}
	...
	public void uninjectChannel(final Channel channel) {
		...
		}catch(Throwable e) {try{channel.pipeline().remove(handlerName);}catch(Throwable e2) {e2.printStackTrace();}}
	}
